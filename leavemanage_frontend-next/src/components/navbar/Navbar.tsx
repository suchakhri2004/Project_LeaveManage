...
import User from '../../app/types/interfaceall';
...
function Navbar() {
  ...
  const renderMenuForRole = () => {
    if (role === 'EMPLOYEE') {
      ...
      if (position === 'นักทรัพยากรบุคคลชำนาญการ' || position === 'ผู้บังคับบัญชา' || position === 'รองปลัดเทศบาลระดับต้น' || position === 'รองปลัดเทศบาลระดับกลาง') {
        return (
          <>
